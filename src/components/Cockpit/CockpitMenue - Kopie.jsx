...
const CockpitMenue = ({ sollPlanAktiv, setSollPlanAktiv, sichtbareGruppen, setSichtbareGruppen, gruppenZähler }) => {
  ...
  useEffect(() => {
    const ladeSchichtgruppen = async () => {
      ...
      setSichtbareGruppen(gruppen); // <- Immer aktiv setzen!
    };
  ...
  return (
    <div className="w-full bg-gray-200 dark:bg-gray-800 text-gray-900 text-md dark:text-white px-4 py-1 rounded-md mb-1 flex flex-wrap items-center gap-2">
      {/* Sollplan-Checkbox */}
